      ...
      <CarouselItem>
        <Card className="p-6 h-80">
          <CardContent>
            ...
            <img src="https://static.wixstatic.com/media/8dffae_84ef3f8654154cfe8412b9d9302e080b~mv2.png/v1/fit/w_2500,h_1330,al_c/8dffae_84ef3f8654154cfe8412b9d9302e080b~mv2.png" alt="angioflex"  className="justify-self-center mt-6 rounded-md"/>
          </CardContent>
        </Card>
      </CarouselItem>
      <CarouselItem>
